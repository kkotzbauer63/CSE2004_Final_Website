...
export const LOCKOUT = {
  ...
  transitions: [
    { action: "1H",  target: "_self",         ui: UI.ANY,  kind: TRANSITION_KIND.MOMENTARY, description: "Momentary low",                                  condition: null, brightnessHint: "floor", momentary: true },
    { action: "2H",  target: "_self",         ui: UI.ANY,  kind: TRANSITION_KIND.MOMENTARY, description: "Momentary moon",                                 condition: null, brightnessHint: "moon", momentary: true },
    ...
    { action: "7C",  target: "LOCKOUT_AUX_PATTERN_CONFIG", ui: UI.FULL, kind: TRANSITION_KIND.NAVIGATE, description: "Aux LEDs: lockout pattern config", condition: null },
    { action: "7H",  target: "LOCKOUT_AUX_COLOR_CONFIG",   ui: UI.FULL, kind: TRANSITION_KIND.NAVIGATE, description: "Aux LEDs: lockout color config",   condition: null },
