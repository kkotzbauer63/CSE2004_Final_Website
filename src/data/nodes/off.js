...
export const OFF = {
  ...
  transitions: [
    ...
    { action: "13H", target: "FACTORY_RESET",    ui: UI.ANY,    kind: TRANSITION_KIND.NAVIGATE,  description: "Factory reset (hold ~4 s)",                       condition: null },
    { action: "15C", target: "VERSION_CHECK",    ui: UI.ANY,    kind: TRANSITION_KIND.NAVIGATE,  description: "Version check",                                   condition: null },
  ],
};
